...
import type { Project, Overview, Source, SourceInspection, Quality, Answer, Evidence, Insight, DatasetType, Reconciliation, IngestionReceipt, AiModels, Conversation, SnapshotComparison } from './types';
...
function Workspace({project}: {project: Project}) {
  ...
  const snapshot=overview?.snapshot, analysis=overview?.analysis, metrics=analysis?.metrics, comparison=overview?.comparison;
