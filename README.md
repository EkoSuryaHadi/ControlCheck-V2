...
- Not connected: external AI provider, multi-table reconciliation, production authentication, tenant permissions, queued ingestion, historical comparisons, PDF export and autonomous actions.
